...
public class TestBrokenLinksInWebPage {
    ...
    public static void main(String args[])
    {
        ...
        List<String> pageLinkList = testBrokenLink.parseOutAllUrlLinksInWebPage("http://www.dailymail.co.uk/");
    ...
    /*
     * Return all valid url links that belong to the same domain in pageUrl.
     * String pageUrl: The web page that need to parse url links out.
     * */
